...
class HomeRepositoryImpl(private val remoteDataSource: RemoteDataSource) : HomeRepository {
    ...
    override suspend fun getProducts(): Flow<ResponseResource<ProductsDTO>> = flow {
    ...
    override suspend fun getProductDetail(id: String): Flow<ResponseResource<ProductsDetailDTO>> =
        flow {
    ...
    override suspend fun getCategoryDetail(id: String): Flow<ResponseResource<ProductsDTO>> = flow {
